"""
Django settings for frosty_truth_dev_109177 project.
...
ROOT_URLCONF = 'frosty_truth_dev_109177.urls'
...
WSGI_APPLICATION = 'frosty_truth_dev_109177.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_truth_dev_109177 API",
    "DESCRIPTION": "API documentation for frosty_truth_dev_109177 App",
    "VERSION": "v1",
}
